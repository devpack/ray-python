...
# Some docs:
#            https://github.com/moderngl/moderngl/blob/main/examples/compute_shader_render_texture.py 
#            https://stackoverflow.com/questions/75613151/executing-a-simple-glsl-compute-shader-with-moderngl-does-not-work
